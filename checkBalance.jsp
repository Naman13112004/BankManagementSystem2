...
<body>
	...
	<%
		int checkAccount = Integer.parseInt(request.getParameter("check_Account")); 
		ArrayList<String[]> customers = (ArrayList<String[]>) session.getAttribute("customers");
		String[] account = customers.get(checkAccount);
	%>
  ...
  <div class="alert alert-success alert-dismissible fade show" role="alert">
  	The balance in the entered account is: <%= account[3]%>
