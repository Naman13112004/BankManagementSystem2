...
<body>
  ...
  <div class="alert alert-success alert-dismissible fade show" role="alert">
    ...
    %>
    Rs.<%= transactionAmount%> has been deposited in account number <%= customers1.indexOf(account1)%>
    <%
        }
    %>
    ...
    <section id="transactions">
      ...
      <form action="addTransaction.jsp">
        ...
        <div class="mb-3">
          ...
          <select class="form-select" id="transactionType" name="transaction">
    ...
    <section id="balance">
      ...
      <form action="checkBalance.jsp">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="checkAccountNumber" placeholder="Enter Account Number" required>
        </div>
